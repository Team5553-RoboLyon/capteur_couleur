...
class Convoyer {
 public:
  ...
  private:
    CustomColorSensor m_leftColorSensor = CustomColorSensor(LEFT_CONVOYER_COLOR_SERSOR);
    CustomColorSensor m_rightColorSensor = CustomColorSensor(RIGHT_CONVOYER_COLOR_SERSOR);
